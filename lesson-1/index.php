    ...
    <section>
        ...
        <article>
            ...
            <p>
                ...
                Пояснение: Результатом выполнения оператора присваивания является само присвоенное значение. Таким
                образом, результат выполнения "$a = 2" будет равен 2
            </p>
            <p>
                ...
                ?><br>
                Пояснение: значением выражения присваивания переменной $x является 4, а $y было присвоено 12.
            </p>
        </article>
